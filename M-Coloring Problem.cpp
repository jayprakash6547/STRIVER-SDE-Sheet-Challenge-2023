...
bool isPossibleMthColor(vector<vector<int>> &mat, vector<int>&node_color_vector, int node_to_colored, int color, int n){
...
bool solve_graph(int node_to_colored, int n ,int m, vector<int> &node_color_vector, vector<vector<int>> &mat)
{
